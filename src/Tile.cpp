...
BrickInstance::BrickInstance(Vector2 pos, std::shared_ptr<Tile> brick) 
    : TileInstance(pos, brick), hbox(Rectangle{pos.x + 24, pos.y + 60, 16, 6}), dest{pos.x, pos.y, TILE_SIZE * SCALE, TILE_SIZE * SCALE}, q_b_a(Q_B_A(pos.y)) {}
...
QuestionInstance::QuestionInstance(Vector2 pos, std::shared_ptr<Tile> question) 
    : TileInstance(pos, question), hbox(Rectangle{pos.x + 24, pos.y + 60, 16, 6}), dest{pos.x, pos.y, TILE_SIZE * SCALE, TILE_SIZE * SCALE}, q_b_a(Q_B_A(pos.y)) {}
