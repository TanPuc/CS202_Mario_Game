...
Level_1_1::Level_1_1(const char *filePath, PlayingState *ps)
{
    tileMap =
        {
...
void Level_1_1::addTileInstance(Vector2 &pos, int &tileID, int &x, int &y, PlayingState *ps)
{
...
void Level_1_1::update(Character &player, ItemManager &itemManager, PlayingState *ps)
{
    for (int i = 0; i < getGridHeight(); i++)
    {
        for (int j = 0; j < getGridWidth(); j++)
        {
            ...
            {
                tileInstancesGrid[i][j]->update(player, itemManager, ps);
    ...
    for (int i = 0; i < getGridHeight(); i++)
    {
        for (int j = 0; j < getGridWidth(); j++)
        {
            if (tileInstancesGrid[i][j])
            {
                ...
                // ÂRectangleLinesEx(tileInstancesGrid[i][j]->bbox, 2.0f, RED); // Debug: Draw bounding box
            }
        }
    }
...
Level_1_3::Level_1_3(const char *filePath, PlayingState *ps)
{
    tileMap =
        {
...
void Level_1_3::addTileInstance(Vector2 &pos, int &tileID, int &x, int &y, PlayingState *ps)
{
    std::shared_ptr<TileInstance> tileInstance = nullptr;
    switch (tileID)
    {
...
void Level_1_3::update(Character &player, ItemManager &itemManager, PlayingState *ps)
{
    for (int i = 0; i < getGridHeight(); i++)
    {
        for (int j = 0; j < getGridWidth(); j++)
...
Level_1_4::Level_1_4(const char *filePath, PlayingState *ps)
{
    srand(time(nullptr));
    tileMap =
        {
...
void Level_1_4::addTileInstance(Vector2 &pos, int &tileID, int &x, int &y, PlayingState *ps)
{
    std::shared_ptr<TileInstance> tileInstance = nullptr;
    switch (tileID)
    {
...
void Level_1_4::update(Character &player, ItemManager &itemManager, PlayingState *ps)
{
    for (int i = 0; i < getGridHeight(); i++)
    {
        for (int j = 0; j < getGridWidth(); j++)
...
void EntityManager::update(Character &player)
{
