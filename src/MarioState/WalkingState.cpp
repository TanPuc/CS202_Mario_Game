...
std::unique_ptr<MarioState> WalkingState::HandleInput(Mario &player, Sprite &sprite)
{
...
std::unique_ptr<MarioState> WalkingState::Update(Mario &player, Sprite &sprite)
{
...
void WalkingState::Draw(Mario &player, Sprite &sprite)
{
    sprite.Draw(player);
}
