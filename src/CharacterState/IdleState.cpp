...
std::unique_ptr<CharacterState> IdleState::HandleInput(Character &player, Sprite &sprite)
{
...
std::unique_ptr<CharacterState> IdleState::Update(Character &player, Sprite &sprite)
{
...
void IdleState::Draw(Character &player, Sprite &sprite)
{
    sprite.Draw(player);
}
